(function () {
    ...
    Mdate.prototype = {
        ...
        createDateBox: function () {
            ...
            var h = yearUl.getElementsByTagName("li")[0].offsetHeight;
            that.initScroll(h);
            that.refreshScroll(h)
        },
        ...
        initScroll: function (h) {
            var that = this;
            yearScroll = new iScroll("yearwrapper", {
                snap: "li",
                vScrollbar: false,
                onScrollEnd: function () {
                    indexY = Math.round(this.y / h * -1 + 1);
            ...
            monthScroll = new iScroll("monthwrapper", {
                ...
                vScrollbar: false,
                onScrollEnd: function () {
                    indexM = Math.round(this.y / h * -1 + 1);
            ...
            dayScroll = new iScroll("daywrapper", {
                ...
                vScrollbar: false,
                onScrollEnd: function () {
                    indexD = Math.round(this.y / h * -1 + 1);
        ...
        refreshScroll: function (h) {
            ...
            inputDay -= initD;
            yearScroll.refresh();
            yearScroll.scrollTo(0, inputYear * h, 300, true);
            monthScroll.scrollTo(0, inputMonth * h, 300, true);
            dayScroll.scrollTo(0, inputDay * h, 300, true)
        },
        dateSure: function () {
            var that = this;
